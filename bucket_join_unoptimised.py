...
with SparkSession.builder.appName("Bucket join optimised").getOrCreate() as spark:
    ...
    joinDF = parkViolations_2015_tbl\
        .join(parkViolations_2016_tbl, (parkViolations_2015_tbl.Plate_Type ==  parkViolations_2016_tbl.Plate_Type) & (parkViolations_2015_tbl.Vehicle_Year ==  parkViolations_2016_tbl.Vehicle_Year) , "inner")\
        .select(parkViolations_2015_tbl["Summons_Number"], parkViolations_2016_tbl["Issue_Date"])
